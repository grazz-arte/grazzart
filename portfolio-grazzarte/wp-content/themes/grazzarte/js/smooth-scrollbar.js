!(function (t, n) {
  ...
  : "object" == typeof exports ? (exports.Scrollbar = n())
  : (t.Scrollbar = n());
})(this, function () {
  return (function (t) {
    function n(r) {
        ...
        s = function (t, n, e) {
          ...
          for (a in e)
            (f = !h && g && void 0 !== g[a]),
              ...
              (p =
                m && f ? c(l, r)
                : y && "function" == typeof l ? c(Function.call, l)
                : l),
              g && u(g, a, l, t & s.U),
              b[a] != l && i(b, a, p),
              y && x[a] != l && (x[a] = l);
    ...
    function (t, n, e) {
      ...
      t.exports = function (t) {
        ...
        return (
          void 0 === t ? "Undefined"
          : null === t ? "Null"
          : "string" == typeof (e = u((n = Object(t)), o)) ? e
          : i ? r(n)
    ...
    function (t, n, e) {
      ...
      function o(t, n, e, r) {
        var o,
          ...
          u =
            i < 3 ? n
            : null === r ? (r = Object.getOwnPropertyDescriptor(n, e))
            : r;
      ...
      function p(t) {
        ...
        var e = _t.test(t);
        return (
          e || wt.test(t) ? St(t.slice(2), e ? 2 : 8)
          : xt.test(t) ? gt
          : +t
        );
      }
      function h(t, n, e) {
        return (
          ...
          void 0 !== e && ((e = Et(e)), (e = e === e ? e : 0)),
          void 0 !== n && ((n = Et(n)), (n = n === n ? n : 0)),
          K(Et(t), n, e)
        );
      }
      function d(t, n) {
      ...
      function k(t, n, e) {
        ...
        if (n && d.contains(n)) {
          ...
          (c && t.isVisible(n)) ||
            t.setMomentum(
              y.left - v.left - l,
              i ? y.top - v.top - a : y.bottom - v.bottom - h
            );
        }
      }
      function D() {
      ...
      function C(t) {
        ...
        function e(t) {
          return (
            w(t, [l.element, l.thumb.element]) ? Vt.X
            : w(t, [p.element, p.thumb.element]) ? Vt.Y
            : void 0
          );
        }
        var r,
        ...
        r(window, "mousemove", function (r) {
          ...
          r(i, "selectstart", function (t) {
            t.stopPropagation(),
              cancelAnimationFrame(e),
              (s = !0),
              E(document.body, { "-user-select": "none" }),
              E(o, { "-user-select": "auto" });
          }),
          r(window, "mouseup blur", function () {
            cancelAnimationFrame(e),
              (s = !1),
              E(document.body, { "-user-select": "" }),
              E(o, { "-user-select": "" });
          }),
      ...
      function W(t) {
        g(t)(
          t.options.wheelEventTarget || t.containerEl,
          (
            "onwheel" in window ||
      ...
      function B(t) {
        ...
        return "wheelDeltaX" in t ?
            { x: t.wheelDeltaX / Xt.OTHERS, y: t.wheelDeltaY / Xt.OTHERS }
          : { x: 0, y: t.wheelDelta / Xt.OTHERS };
      }
      function G() {
      ...
      var Ft,
        ...
        Ht = (function () {
          ...
          return (
            ...
            (t.prototype.update = function (t, n, e) {
              E(this.element, { display: e <= n ? "none" : "block" }),
        ...
        Wt = (function () {
          function t(t) {
            ...
            (this.xAxis = new Ht(X.X, n)),
              (this.yAxis = new Ht(X.Y, n)),
        ...
        Bt = (function () {
          function t(t, n) {
            ...
            (this.scrollbar = t),
              ...
              (this.options = q({}, e.defaultOptions, n));
          }
          return (
        ...
        $t = (function () {
          function t(t, n) {
            ...
            (this.options = new Dt(n)),
              ...
              t.appendChild(r),
              (this.track = new Wt(this)),
              (this.size = this.getSize()),
              (this._plugins = L(this, this.options.plugins));
            var o = t.scrollLeft,
              i = t.scrollTop;
      ...
      (t.exports = e(28)(
        ...
        function () {
          var t = this._t,
            ...
            e = this._i++;
          return (
            !t || e >= t.length ? ((this._t = void 0), o(1))
            : "keys" == n ? o(0, e)
            : "values" == n ? o(0, t[e])
            : o(0, [e, t[e]])
          );
