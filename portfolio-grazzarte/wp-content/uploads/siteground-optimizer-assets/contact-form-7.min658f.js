(() => {
  ...
  const r = window.wp.i18n,
    ...
    t = (e, t, n) => {
      const s = new CustomEvent(`wpcf7${t}`, { bubbles: !0, detail: n });
    ...
    e = (e, n) => {
      ...
      o.has(n) && (n = o.get(n)),
        Array.from(o.values()).includes(n) ||
          (n = `custom-${(n = (n = n.replace(/[^0-9a-z]+/i, " ").trim()).replace(/\s+/, "-"))}`);
      const s = e.getAttribute("data-status");
      if (
        ((e.wpcf7.status = n),
        e.setAttribute("data-status", n),
        e.classList.add(n),
        s && s !== n)
      ) {
        ...
        (e) => {
          ...
          "string" == typeof c &&
            ...
            "string" == typeof s &&
              ...
              (s = s.replace(/^\//, "")),
              (r = t + s)),
            (o = { Accept: "application/json, */*;q=0.1", ...o }),
            delete o["X-WP-Nonce"],
            d &&
              ((l = JSON.stringify(d)),
          ...
          return window
            .fetch(r || s || window.location.href, {
              ...h,
              headers: o,
              body: l,
            })
  ...
  function u(t, n = {}) {
                ...
                if (t.name)
                  switch (t.type) {
                    ...
                    case "select-multiple":
                      for (const n of t.selectedOptions)
    ...
    Promise.resolve(e(t, "validating"))
      .then((e) => {
        if (void 0 !== swv) {
          ...
          for (const c of r) {
            ...
            if (e.has(n)) {
              const { error: s, validInputs: r } = e.get(n);
              i(t, n),
                void 0 !== s && a(t, n, s, { scope: o }),
                h(t, n, r ?? []);
            }
  ...
  const a = (e, t, n, s) => {
      const { scope: a = e, ...r } = s ?? {},
        i = `${e.wpcf7?.unitTag}-ve-${t}`.replaceAll(/[^0-9a-z_-]+/gi, ""),
        o = e.querySelector(
      ...
      (() => {
        ...
        t.setAttribute("id", i),
          o && o.id ?
            t.insertAdjacentHTML("beforeend", `<a href="#${o.id}">${n}</a>`)
    ...
    i = (e, t) => {
      ...
      e.wpcf7.parent
        .querySelector(`.screen-reader-response ul li#${n}`)
        ?.remove(),
        e
          .querySelectorAll(`.wpcf7-form-control-wrap[data-name="${t}"]`)
          .forEach((e) => {
    ...
    h = (e, t, n) => {
      e.querySelectorAll(`[data-reflection-of="${t}"]`).forEach((e) => {
        if ("output" === e.tagName.toLowerCase()) {
          const t = e;
          0 === n.length && n.push(t.dataset.default),
            n.slice(0, 1).forEach((e) => {
  ...
  function m(s, i = {}) {
    ...
    i.submitter &&
      i.submitter.name &&
      c.append(i.submitter.name, i.submitter.value);
    const r = {
    ...
    n({
      ...
      method: "POST",
      body: c,
      wpcf7: { endpoint: "feedback", form: s, detail: r },
    })
      .then((n) => {
        ...
        return (
          (r.status = n.status),
          (r.apiResponse = n),
          ["invalid", "unaccepted", "spam", "aborted"].includes(o) ?
            t(s, o, r)
          : ["sent", "failed"].includes(o) && t(s, `mail${o}`, r),
          t(s, "submit", r),
          n
        );
      })
      .then((e) => {
        e.posted_data_hash &&
          (s.querySelector('input[name="_wpcf7_posted_data_hash"]').value =
            e.posted_data_hash),
          "mail_sent" === e.status &&
            (s.reset(), (s.wpcf7.resetOnMailSent = !0)),
          e.invalid_fields &&
            e.invalid_fields.forEach((e) => {
              a(s, e.field, e.message);
            }),
          s.wpcf7.parent
            .querySelector('.screen-reader-response [role="status"]')
            .insertAdjacentText("beforeend", e.message),
          s.querySelectorAll(".wpcf7-response-output").forEach((t) => {
  ...
  function f(s) {
    ...
    n({
      ...
      method: "GET",
      wpcf7: { endpoint: "refill", form: s, detail: o },
    })
      .then((n) => {
        s.wpcf7.resetOnMailSent ?
          (delete s.wpcf7.resetOnMailSent, e(s, "mail_sent"))
        : e(s, "init"),
          (o.apiResponse = n),
          t(s, "reset", o);
      })
      ...
      for (const n in t) {
        ...
        e.querySelectorAll(
          ...
          (e.querySelector(`input[name="${n}"]`).value = ""),
            (e.querySelector(".wpcf7-quiz-label").textContent = s),
    ...
    (e.wpcf7 = {
      ...
      ((e) => {
        e.querySelectorAll(".has-free-text").forEach((t) => {
          ...
          (s.disabled = !n.checked),
            e.addEventListener("change", (e) => {
              (s.disabled = !n.checked),
                e.target === n && n.checked && s.focus();
            });
        });
      })(e),
      ((e) => {
      ...
      e.addEventListener("wpcf7submit", (t) => {
        t.detail.apiResponse.captcha && l(e, t.detail.apiResponse.captcha),
          t.detail.apiResponse.quiz && d(e, t.detail.apiResponse.quiz);
      }),
