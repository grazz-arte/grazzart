(() => {
    ...
    for (const [o, s] of this.formData) {
      ...
      if (e)
        if ("" === e.groups.array) this.tree.set(e.groups.name, s);
          ...
          const n = [
            ...e.groups.array.matchAll(/\[([a-z][-a-z0-9_:]*|[0-9]*)\]/gi),
          ].map(([e, t]) => t);
  ...
  s.r(t),
    ...
    (n.prototype.getAll = function (e) {
      ...
      const t = (e) => {
        const n = [];
        if (e instanceof Map) for (const [o, s] of e) n.push(...t(s));
        else "" !== e && n.push(e);
        return n;
      };
      return t(this.get(e));
  ...
  const z = n;
  function e({ rule: e, field: t, error: n, ...s }) {
  ...
  const M = function (t) {
    ...
    g = function (t) {
      if (
        !t
          ...
          .every(
            (e) => (
              ((e = (e = e.replace(/[#*].*$/, "")).replaceAll(
                /[()/.*#\s-]+/g,
                ""
              )).startsWith("+") ||
                e.startsWith("00")) &&
                (e = `+${e.replace(/^[+0]+/, "")}`),
              !!/^[+]?[0-9]+$/.test(e) && 5 < e.length && e.length < 16
            )
          )
      )
        throw new e(this);
    ...
    l = function (t) {
      if (
        t
          .getAll(this.field)
          .map((e) => e.trim())
          .filter((e) => "" !== e).length < parseInt(this.threshold)
      )
        throw new e(this);
    },
    v = function (t) {
    ...
    E = function (t) {
      ...
      if (
        !s.every((e) => {
          ...
          return (
            "0.000000" === Math.abs(t).toFixed(6) ||
            "0.000000" === Math.abs(t - n).toFixed(6)
          );
        })
      )
        throw new e(this);
    },
    r = ({ ruleObj: e, options: n }) => {
      const { rule: s, ...o } = e;
      return (
        "function" == typeof t[s] &&
        ("function" != typeof t[s].matches || t[s].matches(o, n))
      );
    },
    a = ({ ruleObj: e, formDataTree: n, options: s }) => {
      const { rule: o } = e;
      t[o].call(e, n, s);
    },
    c = [],
    ...
    F = function (t, n = {}) {
      const s = (this.rules ?? []).filter((e) => r({ ruleObj: e, options: n })),
        o = i(a);
      if (
        !s.every((s) => {
          try {
            o({ ruleObj: s, formDataTree: t, options: n });
          } catch (t) {
  ...
  window.swv = {
    validators: t,
    validate: (t, n, s = {}) => {
      const l = (t.rules ?? []).filter((e) => r({ ruleObj: e, options: s }));
      if (!l.length) return new Map();
      const d = i(a),
        o = new z(n),
        c = l.reduce((t, n) => {
          try {
            d({ ruleObj: n, formDataTree: o, options: s });
          } catch (n) {
            if (!(n instanceof e)) throw n;
            if (void 0 !== n.field && !t.has(n.field) && void 0 !== n.error)
              return t.set(n.field, n);
          }
          return t;
        }, new Map());
      for (const e of o.keys())
        c.has(e) || c.set(e, { validInputs: o.getAll(e) });
      return c;
    },
    use: (e) => {
      c.push(e);
